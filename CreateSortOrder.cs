...
namespace Auto_Sort {
    public static class CreateSortOrder {
        public static Dictionary<string, int> Get() {
            ...
            itemSortOrders.Add("Simple Explosives", ++i);
            itemSortOrders.Add("Improved Explosives", ++i);
            itemSortOrders.Add("Advanced Explosives", ++i);
            itemSortOrders.Add("Starter Structures Schematic", ++i);
            itemSortOrders.Add("Improved Structures Schematic", ++i);
            ...
            itemSortOrders.Add("Alloy T1 ingot", ++i);
            itemSortOrders.Add("Alloy T2 ingot", ++i);
            itemSortOrders.Add("Alloy T3 ingot", ++i);
            ...
            itemSortOrders.Add("Copper Levers", ++i);
            itemSortOrders.Add("Copper gun components", ++i);
            itemSortOrders.Add("Copper bullet casings", ++i);
            ...
            itemSortOrders.Add("Iron bullet casings", ++i);

            itemSortOrders.Add("Titan bolts", ++i);
            itemSortOrders.Add("Titan plates", ++i);
            itemSortOrders.Add("Titan tubes", ++i);
            itemSortOrders.Add("Titanium bullet casings", ++i);

            itemSortOrders.Add("Black powder", ++i);
            itemSortOrders.Add("Dials", ++i);
            ...
            itemSortOrders.Add("Refinery Worktable", ++i);
            itemSortOrders.Add("Research Worktable", ++i);
            itemSortOrders.Add("Bed", ++i);
